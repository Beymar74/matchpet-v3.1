'use client'; // Marca el archivo como un componente cliente para usar hooks de React

import React, { useState } from 'react';
import { CheckCircle, XCircle, Phone, Filter } from 'lucide-react'; // Asegúrate de importar todo lo necesario
